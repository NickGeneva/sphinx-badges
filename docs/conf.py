...
badges_definitions = {
    # Stability group
    "stability:stable":       {"label": "Stable",       "color": "#198754", "text_color": "#ffffff"},
    "stability:beta":         {"label": "Beta",         "color": "#0dcaf0", "text_color": "#000000"},
    "stability:experimental": {"label": "Experimental", "color": "#ffc107", "text_color": "#000000"},
    "stability:deprecated":   {"label": "Deprecated",   "color": "#dc3545", "text_color": "#ffffff"},
